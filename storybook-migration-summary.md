...
- `npx storybook@latest automigrate --config-dir libs/porrtal-components/r-learning/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/porrtal-components/a-learning/.storybook --renderer @storybook/angular`
